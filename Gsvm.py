...
This class should not be called directly. Instead it should be used only via the class PySats.py. See Test_javabridge.py for an example of how to use the class  _Gsvm.
"""
